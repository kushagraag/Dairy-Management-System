                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="table-wrap">
                                            ...
                                            <?php if ($_SESSION['aid'] > 10) {
                                                        $query = mysqli_query($con, "select * from tblusers where id='$loginid'");
                                                        $row = mysqli_fetch_array($query);
                                                        $cname = $row['name'];
                                                        $query = mysqli_query($con, "select distinct InvoiceNumber,CustomerName,CustomerContactNo,PaymentMode,InvoiceGenDate  from tblorders where CustomerName = '$cname'");
                                                    }
                                                    else{

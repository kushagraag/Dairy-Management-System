...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['checkout'])) {
        ...
        if ($_SESSION['aid'] > 10) {
            $query = mysqli_query($con, "select * from tblusers where id='$loginid'");
            $row = mysqli_fetch_array($query);
            $cname = $row['name'];
            $cmobileno = $row['Contact']; 
        }
            ...
            <div class="hk-pg-wrapper">
                ...
                <nav class="hk-breadcrumb" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-light bg-transparent">
                        <li class="breadcrumb-item"><a href="# i">Search</a></li>
                                        ...
                                        <div class="col-sm">
                                            <div class="table-wrap">
                                                ...
                                                ?>
                                                    ...
                                                    <?php
                                                    if ($_SESSION['aid'] <= 10) {
                                                        echo "<div class='form-row'><div class='col-md-6 mb-10'><label for='validationCustom03'>Customer Name</label><input type='text' class='form-control' id='validationCustom03' placeholder='Customer Name' name='customername' required><div class='invalid-feedback'>Please provide a valid customer name.</div></div><div class='col-md-6 mb-10'><label for='validationCustom03'>Customer Mobile Number</label><input type='text' class='form-control' id='validationCustom03' placeholder='Mobile Number' name='mobileno' required><div class='invalid-feedback'>Please provide a valid mobile number.</div></div></div>";
                                                        // $customername = mysqli_query($con, "select name from tblusers where id = " . $_SESSION['aid'] );
                                                    }
                                                    ?>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-6 mb-10">
                                                            ...
                                                            <div class="custom-control custom-radio mb-10">
                                                                <input type="radio" class="custom-control-input" id="customControlValidation3" name="paymentmode" value="UPI" required>
                                                                <label class="custom-control-label" for="customControlValidation3">UPI</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 mb-10">

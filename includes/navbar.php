     <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
         ...
         <a class="navbar-brand" href="dashboard.php">milk base
         </a>
                 ...
                 <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     <div class="media">
                         ...
                         <?php
                            ...
                            if ($_SESSION['aid'] <= 10) {
                                $query = mysqli_query($con, "select name from tbladmin where id='$loginid'");
                            } else {
                                $query = mysqli_query($con, "select name from tblusers where id='$loginid'");
                            }
